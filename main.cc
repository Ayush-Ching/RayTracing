...
int main() {
    ...
    auto material_left   = make_shared<dielectric>(color(0.7, 1.0, 0.7), 1.50);
    auto material_bubble = make_shared<dielectric>(color(0.7, 0.7, 1.0), 1.0 / 1.50);
    ...
    world.add(make_shared<sphere>(point3(-1.2,    0.0, -1.5),   0.4, material_bubble));
